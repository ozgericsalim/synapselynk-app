  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[{ label: 'Bugunun Seanslari', icon: Calendar, val: '0', color: 'emerald' },
          { label: 'Aktif Danisanlar', icon: Users, val: '0', color: 'blue' },
          { label: 'Diyet Planlari', icon: Utensils, val: '0', color: 'purple' },
          { label: 'Yeni Mesajlar', icon: MessageSquare, val: '0', color: 'amber' }].map(({ label, icon: Icon, val, color }) => (
